 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.myexpo-ownerapp.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.myexpo.ownerapp'; // ios bundle id
const PACKAGE = 'com.myexpo_ownerapp'; // android package name
const NAME = 'Myexpo-ownerApp'; // app name
const EXPO_ACCOUNT_OWNER = 'expo-owner'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'Myexpo-ownerApp'; // app scheme
...
/**
 * Special function for Android package names - uses underscores instead of dots for environment suffix
 * @param {string} name
 * @returns {string}
 */
const withAndroidEnvSuffix = (name) => {
  return APP_ENV === 'production' ? name : `${name}_${APP_ENV}`;
};
...
const _clientEnv = {
  ...
  PACKAGE: withAndroidEnvSuffix(PACKAGE),
